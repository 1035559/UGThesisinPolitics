speeches44 <- read.csv("C:/Users/[PATH]/master44.csv")
speeches45 <- read.csv("C:/Users/[PATH]/master45.csv")
listseats <- read.csv("C:/Users/[PATH]/ListElectorate.csv")
whipping <- read.csv("C:/Users/[PATH]/WhipPrediction.csv")
parliaments<- read.csv("C:/Users/[PATH]/44to45.csv")
library(dplyr)
library(ggplot2)
require(moonBook)
require(ggiraph)
